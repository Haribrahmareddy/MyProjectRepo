...
console.log(loginInfo)
      ...
      if (response.data.login === "success") {
        ...
        setErrMessage(response.data.login)
      }
    } catch (error) {
  ...
  return (
    <Container width=" max-w-4xl flex justify-center items-center h-[80vh] ">
      <form onSubmit={handleSubmit}>
        <h1 className="text-center p-4 text-3xl font-medium">Sign Up</h1>
        <div className="w-96">
          <input
        ...
        <div className="w-96">
          ...
          <p className="mt-3 text-center">
            Have an account:&nbsp;&nbsp;
            <Link to={'/signin'}className="text-purple-500 underline font-semibold"> SignIn</Link>
          </p>
        </div>
      </form>
    </Container>
